...
$group_config = [
    ...
    [
        ...
        'desc'  => __( 'Automatically deletes trashed content after 7 days.', 'cc-head-cleaner-and-speedup' ),
    ],
    [
        'id'    => 'define_autosave_interval',
        'label' => __( 'Adjust Autosave Interval (300 seconds)', 'cc-head-cleaner-and-speedup' ),
        'desc'  => __( 'Reduces autosave frequency to lower server load.', 'cc-head-cleaner-and-speedup' ),
    ],
    [
